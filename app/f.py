...
textarea {
    width: 100%; /* Example to ensure it fits container */
    padding: 10px; /* Example for padding */
    border: 1px solid #ccc; /* Example for border */
...
def form_submit():
    if request.method == 'POST':
        ...
        with open("markers.json", 'r') as json_file:
        ...
        with open('markers.json', 'w') as marker_file:
